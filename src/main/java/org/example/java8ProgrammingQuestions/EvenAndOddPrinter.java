...
public class EvenAndOddPrinter {
    ...
    private static IntPredicate oddCondition = e -> e%2 == 1;

    public static void main(String[] args) throws InterruptedException {
        CompletableFuture.runAsync(() -> EvenAndOddPrinter.printResult(oddCondition));
        CompletableFuture.runAsync(() -> EvenAndOddPrinter.printResult(evenCondition));
        Thread.sleep(1000);
    }
